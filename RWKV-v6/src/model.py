...
class Block(nn.Module):
    ...
    def __init__(self, layer_id, n_layer, n_embd, n_head, head_size, dropout, dim_att, dim_ffn,lora_r, lora_alpha, lora_dropout):
        #global LORA_CONFIG
        ...
        self.att = RWKV6_0_TimeMix(layer_id, n_layer, n_embd, n_head, head_size, dropout, dim_att , lora_r, lora_alpha, lora_dropout)
        self.ffn = RWKV_ChannelMix(layer_id, n_layer, n_embd, dim_ffn , lora_r, lora_alpha, lora_dropout)
...
class RWKV(L.LightningModule):
    ...
    def __init__(self,
        ...
        self.blocks = nn.ModuleList([
            Block(i, n_layer, n_embd, n_head, head_size, dropout, dim_att, dim_ffn,lora_r,lora_alpha,lora_dropout) for i in range(n_layer)
        ])
