...
if __name__ == "__main__":
    ...
    TemporaryCheckpointName = "Temporary.pth"
    if output_file == "" or output_file is None:
        output_file = os.path.join(args.checkpoint_dir, "rwkv_model.pth")
    convert_zero_checkpoint_to_fp32_state_dict(args.checkpoint_dir, TemporaryCheckpointName, save_dtype=args.dtype)
    ### RWKV modified code ###
    ...
    lora = TemporaryCheckpointName#args.lora_checkpoint
    output = output_file
